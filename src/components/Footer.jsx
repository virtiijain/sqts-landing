...
const Footer = () => (
  <footer className="bg-gray-950 text-white pt-16 pb-8">
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
      ...
      <div className="md:col-span-1">
        ...
        <p className="text-gray-400 leading-relaxed">
          Our wish is to accomplish your wish. We provide IT services, staffing, and digital solutions to help businesses scale and succeed in the digital world.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3">
          ...
          <li className="hover:text-blue-500 cursor-pointer transition-colors duration-300">Why Choose Us</li>
      ...
      <div>
        ...
        <ul className="space-y-3">
          <li className="hover:text-blue-500 cursor-pointer transition-colors duration-300">Web Development</li>
          <li className="hover:text-blue-500 cursor-pointer transition-colors duration-300">Digital Marketing & SEO</li>
          <li className="hover:text-blue-500 cursor-pointer transition-colors duration-300">Data Analytics & CRM</li>
          <li className="hover:text-blue-500 cursor-pointer transition-colors duration-300">IT Staff Augmentation</li>
        </ul>
      </div>
    ...
    <div className="text-center text-gray-500 mt-6">
      &copy; {new Date().getFullYear()} Spark Que Tech Solutions. All rights reserved.
    </div>
  </footer>
);
